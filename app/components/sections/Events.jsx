			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-6">
				...
				<div className="bg-gradient-to-br from-blue-900 from-50% to-90% to-blue-300 rounded-lg p-6 shadow-lg flex flex-col gap-4">
					...
					<div className='grid grid-cols-1 md:grid-cols-[1fr,auto] text-sm items-center'>
						...
						<a href="https://island-dao.com/" className='w-full' target="blank" rel="noopener noreferrer"><button className=" bg-[#0A1494] px-3 py-2 rounded-full w-full md:w-fit h-fit hover:bg-blue-600 transition">
							Explore the fun!
						</button>
						</a>
					</div>
				...
				<div className="bg-gradient-to-br from-[#081E20] from-50% to-white rounded-lg p-6 shadow-lg flex flex-col gap-4">
					...
					<div className='grid grid-cols-1 md:grid-cols-[1fr,auto] text-sm items-center'>
						...
						<a href="https://island-dao.com/" target="blank" rel="noopener noreferrer" className="w-full"><button className=" bg-[#081E20] px-3 py-2 rounded-full w-full md:w-fit h-fit hover:bg-gray-600 transition">
							Explore the fun!
						</button>
						</a>
					</div>
